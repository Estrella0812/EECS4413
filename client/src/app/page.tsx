        ...
        <div className="">
            ...
            <section className="max-w-7xl mx-auto grid lg:grid-cols-2 grid-cols-1 gap-24 p-4">
                <div className="flex flex-col justify-center">
                    ...
                    <Link href="/search" prefetch={false} className="text-center mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 max-w-[200px] rounded-full gradient-bg">
                        SHOP NOW
                    </Link>
                </div>
            ...
            <section className="max-w-7xl mx-auto my-38">
                ...
                <div className="grid lg:grid-cols-20 grid-cols-2 gap-4">
                    {Categories.map((category, index) => (
                        ...
                        <Link href={`/search?category=${category}`} key={index} prefetch={false} className={"relative col-span-4 bg-zinc-900 rounded-lg p-4 w-full aspect-square cursor-pointer" + (index === 0 ? " col-start-3" : "")}>
                            <Image
